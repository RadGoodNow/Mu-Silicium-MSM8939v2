...
class CommonPlatform ():
    PackagesSupported = ("idoPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('ido', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "ido", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "idoPkg/ido.dsc", "Platform Hardcoded")
